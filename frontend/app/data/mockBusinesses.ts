...
export const mockBusinesses: BusinessData[] = [
  ...
  {
    id: "green-fresh-market",
    name: "Green Fresh Market",
    category: "Commerce",
    description: `Neighborhood market focused on organic and fresh produce. Partnership with local farmers
    and weekly delivery subscriptions. Looking for investment to expand cold storage and add bakery section.`,
    shortDescription: "Organic neighborhood market with subscription deliveries",
    location: { city: "São Paulo", state: "SP", address: "Rua dos Pinheiros, 980" },
    images: [
      "https://images.unsplash.com/photo-1511689660979-2d178e84f6f3?w=800",
      "https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=800",
      "https://images.unsplash.com/photo-1556742041-82d7b99c15f5?w=800",
    ],
    logo: "https://images.unsplash.com/photo-1511689660979-2d178e84f6f3?w=200",
    owner: { name: "Julia Ferreira", role: "Manager", avatar: "https://i.pravatar.cc/150?img=21" },
    financials: { monthlyRevenue: 72000, monthlyCosts: 48000, netProfit: 24000, yearlyGrowth: 22.1, valuation: 650000 },
    sharesInfo: { totalShares: 1000, availableShares: 300, pricePerShare: 650, minInvestment: 3250 },
    metrics: { yearsInBusiness: 4, employees: 9, monthlyCustomers: 2800, rating: 4.6 },
    documents: { hasBusinessPlan: true, hasFinancialReport: true, hasLegalDocs: true },
    aiAnalysis: {
      score: 81,
      strengths: ["Recurring subscriptions", "Local supplier partnerships", "Growing health-conscious demand"],
      risks: ["Supply volatility", "Perishables waste management"],
      recommendation: "Balanced investment with steady growth potential.",
    },
  },
  {
    id: "urban-bikes-service",
    name: "Urban Bikes Service",
    category: "Services",
    description: `Bike repair and accessory store with mobile service around the city. Membership model for
    commuters. Seeking funds to expand fleet and open a second service point.`,
    shortDescription: "Bike repair with mobile assistance and memberships",
    location: { city: "São Paulo", state: "SP", address: "Rua da Consolação, 1120" },
    images: [
      "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=800",
      "https://images.unsplash.com/photo-1520975598405-9f108941c7a6?w=800",
      "https://images.unsplash.com/photo-1520975661595-6451951e8b2f?w=800",
    ],
    logo: "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=200",
    owner: { name: "Marcos Vieira", role: "Founder", avatar: "https://i.pravatar.cc/150?img=27" },
    financials: { monthlyRevenue: 38000, monthlyCosts: 25000, netProfit: 13000, yearlyGrowth: 28.4, valuation: 350000 },
    sharesInfo: { totalShares: 1000, availableShares: 400, pricePerShare: 350, minInvestment: 1750 },
    metrics: { yearsInBusiness: 2, employees: 5, monthlyCustomers: 1200, rating: 4.4 },
    documents: { hasBusinessPlan: true, hasFinancialReport: false, hasLegalDocs: true },
    aiAnalysis: {
      score: 74,
      strengths: ["Membership recurring revenue", "High urban mobility demand"],
      risks: ["New business with limited track record"],
      recommendation: "Moderate risk with high upside in urban mobility.",
    },
  },
  {
    id: "kids-learning-center",
    name: "Kids Learning Center",
    category: "Services",
    description: `After-school learning and activities center with STEM focus. Partnerships with local schools,
    monthly plans for families. Investment target: equipment and new classroom.`,
    shortDescription: "After-school STEM learning center",
    location: { city: "São Paulo", state: "SP", address: "Alameda Santos, 450" },
    images: [
      ...
      "https://images.unsplash.com/photo-1519457966870-2c9dce4d8a67?w=800",
    ],
    logo: "https://images.unsplash.com/photo-1511988617509-a57c8a288659?w=200",
    owner: { name: "Patricia Gomes", role: "Director", avatar: "https://i.pravatar.cc/150?img=41" },
    financials: { monthlyRevenue: 56000, monthlyCosts: 39000, netProfit: 17000, yearlyGrowth: 19.7, valuation: 520000 },
    sharesInfo: { totalShares: 1000, availableShares: 320, pricePerShare: 520, minInvestment: 2600 },
    metrics: { yearsInBusiness: 5, employees: 11, monthlyCustomers: 300, rating: 4.7 },
    documents: { hasBusinessPlan: true, hasFinancialReport: true, hasLegalDocs: true },
    aiAnalysis: {
      score: 83,
      strengths: ["School partnerships", "Strong parental demand", "Recurring monthly plans"],
      risks: ["Operational scaling", "Staff training requirements"],
      recommendation: "Consistent returns and community impact.",
    },
  },
  {
